...
- [**EXECUTIVE SUMMARY**](#EXECUTIVE%20SUMMARY)
1. [Introduction](#Introduction)

2. [Principal Areas of Consultation](#Principal%20Areas%20of%20Consultation)

3. [Consultation Period](#Consultation%20Period)

- [**BACKGROUND**](#BACKGROUND)
I. [The 1994 Joint Policy Statement](#The%201994%20Joint%20Policy%20Statement)

II. [Position since 1994 and Factors leading to the Public Consultation](#Position%20since%201994%20and%20Factors%20leading%20to%20the%20Public%20Consultation)

III. [Characteristics of the Combined Offering Mechanism](#Characteristics%20of%20the%20Combined%20Offering%20Mechanism)

- [**AREAS OF CONSULTATION**](#AREAS%20OF%20CONSULTATION)
I. [Minimum size for the Subscription Tranche](#Minimum%20size%20for%20the%20Subscription%20Tranche)

II. [The SEHK's discretion on the Use of Placing](#The%20SEHK)

III. [Underwriters' discretion on the allocation of shares in the Placing Tranche](#Underwriters)

IV. [Extent of Over-Allocation of Shares](#Extent%20of%20Over-Allocation%20of%20Shares)

V. [Over-allocation between the Subscription Tranche and the Placing Tranche](#Over-allocation%20between%20the%20Subscription%20Tranche%20and%20the%20Placing%20Tranche)

VI. [Flexibility in Adjusting the Price, Size and Timing of an Offer](#Flexibility%20in%20Adjusting%20the%20Price,%20Size%20and%20Timing%20of%20an%20Offer)

VII. [Eligibility to apply for shares in the Subscription Tranche and the Placing Tranche](#Eligibility%20to%20apply%20for%20shares%20in%20the%20Subscription%20Tranche%20and%20the%20Placing%20Tranche)

VIII. [Announcement of indications of interests in the Placing Tranche](#Announcement%20of%20indications%20of%20interest%20in%20the%20Placing%20Tranche)

- [**CONSULTATION**](#CONSULTATION)
APPENDIX 1 : [Joint Policy Statement on Offering Mechanisms (November 1994)](#APPENDIX%201)

APPENDIX 2 : [List of Global Equity Offerings (1993 - May 1997)](#APPENDIX%202)

APPENDIX 3 : [Joint Statement on Global Offering Mechanisms (July 1996)](#APPENDIX%203)

APPENDIX 4 : [Book-building: General Information](#APPENDIX%204)

APPENDIX 5 : [The Combined Offering Mechanism](#APPENDIX%205)

APPENDIX 6 : [Joint Announcement on Allocation of Shares in Initial Public Offerings (May 1997)](#APPENDIX%206)
...
- ***(i) Minimum size for the public subscription tranche*** : As the main purpose of having the subscription tranche is to meet the demand of local investors who provide liquidity to the market, the SFC and the SEHK believe that a channel should be open for Hong Kong demand to be sufficiently met. The need to balance Hong Kong investor demand against the flexibility offered by the book-built placing method has always been in the fore-front of the regulators' priorities. Accordingly, whilst the SFC and the SEHK continue to hold the view that allocation of shares between the public subscription tranche and the placing tranche remains, to a large extent, a commercial decision for issuers and underwriters, it is believed that for the interests of the Hong Kong market as a whole, a minimum size of the subscription tranche should be specified. It is recommended that the initial size of the subscription tranche be set at a minimum of 10% of an issue, with a clawback provision allowing that tranche to be increased up to 30% of the total issue size if it is 15 times subscribed, and up to 50% of the total issue size if that tranche is 50 times subscribed. (Paragraphs 21 to 32).
- ***(ii)*** ***SEHK's discretion on the use of placing*** : The combined offering mechanism involving a public subscription tranche and a book-built placing tranche in an IPO was specifically approved for the purpose of facilitating large scale multi-jurisdictional equity offerings. It was not intended that such offering mechanism be used in all IPOs on the SEHK. Accordingly, the SEHK wishes to remind underwriters and issuers that it may, pursuant to Rule 7.10 of the Listing Rules, exercise its discretion not to allow, or impose restrictions on, any part of an issue to be offered by way of placing (Paragraphs 33 to 36).
- ***(iii)*** ***Underwriters' discretion on the allocation of shares in the placing tranche*** : Some market participants have expressed concerns that there is currently not sufficient transparency on how underwriters exercise their discretion in the allocation of shares in the placing tranche. The questions raised include whether underwriters should be required to disclose how discretion is to be exercised, and whether regulations should be introduced to prescribe how underwriters ought to exercise their discretion. Whilst the SFC and the SEHK expect underwriters to act fairly and in the best interests of issuers when allocating shares, it is not recommended that rules be introduced either to require detailed disclosure on how discretion is to be exercised or to prescribe how underwriters ought to exercise their discretion under the placing tranche of an offer (Paragraphs 37 to 40).
- ***(iv) Extent of over-allocation of shares*** : The creation of short positions by underwriters without the benefit of an over-allotment option, or creating short positions in excess of the limit under which shares could be allocated under such option will be subject to the scrutiny of the SFC under the relevant provisions of the Securities Ordinance which prohibit market manipulation activities (Paragraphs 41 to 47).
- ***(v) Over-allocation between the subscription tranche and the placing tranche*** : In order to maintain the balance between the public subscription tranche and the placing tranche, the SFC and the SEHK will require that over-allocated shares be divided in such a way that the total amount of shares ultimately allocated to the two tranches would bear the same ratio as that originally set between them before any over-allocation takes place (Paragraphs 48 and 49).
- ***(vi) Flexibility in adjusting the price, size and timing of an offer*** : The Companies Ordinance requires certain parameters to be specified in Hong Kong prospectuses. For global offerings where the book-building period remains open during the offer period of the subscription tranche, underwriters believe that the book-building process is, to a certain extent, limited by such parameters. As Hong Kong prospectuses are issued prior to the close of the "book", underwriters are seeking flexibility under the subscription tranche in adjusting the price range, the size and the timing of an issue prior to the close of the offer period. Whilst the SFC and the SEHK note that introducing greater flexibility in the areas mentioned above would help make Hong Kong more attractive to issuers, the whole question has to be considered with care, and the SFC and the SEHK believe that if any flexibility were to be allowed, the relevant legal issues must, in any event, have to be addressed and sufficient safeguards must be in place for the benefit of investors under the subscription tranche (Paragraphs 50 to 63).
- ***(vii) Eligibility to apply for shares in the subscription tranche and the placing tranche*** : Traditionally, the subscription tranche is intended for the participation of retail investors, and the placing tranche for institutional investors. However, it has been noted that high level of subscriptions by non-retail Hong Kong investors reduces the proportion of shares that could be allocated to retail investors. Over-subscriptions of IPOs have also caused imbalance in the supply and demand of funds in the banking system resulting, among other things, in the increase of short term interest rates on Hong Kong dollar. The SFC and the SEHK wish to seek the public's view on the approach that should be adopted to address these issues. Apart from maintaining the existing system, two possible approaches have been identified. Under the first approach, all investors are eligible to apply for shares under the placing tranche and the subscription tranche (with subscriptions for large and small amounts to be separated into two pools), but rules would be introduced to prevent investors who have applied for shares under one tranche from applying for shares under the other tranche. Under the second approach, participation in the subscription tranche would be limited to "retail" investors only; and participation in the placing tranche would be limited to "non-retail" investors only. An objective set of criteria would have to be established to define whether an investor would be regarded as a "retail investor", with the rest of the investors to be regarded as "non-retail investors" (Paragraphs 64 to 77).
- ***(viii) Announcement of indications of interests in the placing tranche*** : Certain sectors of the market consider that transparency of the placing tranche should be improved by requiring issuers and underwriters to disclose the extent of demand for shares under that tranche by describing the indications of interest expressed by investors in gross numerical terms. It is suggested that such disclosure should be made before the commencement of trading of the relevant securities in Hong Kong. This would also eliminate implications under the Securities (Insider Dealing) Ordinance when underwriters conduct short coverings or other dealings of the relevant securities in the Hong Kong market. (Paragraphs 78 to 86).
**Consultation Period**
...
- (i) The need to introduce alternative offering mechanisms was recognised. It was accepted that global equity offerings which involved the listing of large scale new issues on the SEHK raising funds from the domestic and international markets could be conducted by the simultaneous offer of shares in Hong Kong by way of the traditional public subscription method (which forms the Hong Kong subscription tranche) and the placing of shares to international investors by using the book-building method (which forms the international placing tranche).
- (ii) In respect of such global offerings, the Working Party believed at the time that the size of the subscription tranche and the placing tranche was a matter for the issuer and the underwriter to decide. The Working Party did not stipulate a minimum dollar value or percentage of a new issue that must be allocated for public subscription in Hong Kong. However, underwriters and issuers were expected to give due regard to the interests of local retail investors in developing offering mechanisms that would be suitable for their new issues.
- (iii) Inter-tranche flow of allocations between the Hong Kong and international tranche should be permitted so that securities may be allocated to markets where real demand lies. The objective was to facilitate optimal equilibrium between the primary market supply and demand and to minimise market imbalance.
- (iv) Where underwriters have over-allotted in an offering, genuine purchases in the secondary market effected solely for the purpose of covering such over-allotment would not of themselves infringe the relevant provisions of the Securities Ordinance which prohibit market manipulation in the form of pegging or stabilising the price of securities.
...
- (i) how underwriters exercise their discretion when allocating shares to investors under the placing tranche; and
- (ii) the level of indications of interest expressed by investors under the placing tranche during the book-building period.
...
- (i) Underwriters represent that at the time the Hong Kong prospectuses are completed, the book-building process has not yet been completed, hence, the price range is still indicative under the placing tranche. There is an increasing trend for demand in large and complex transactions to be indicated by investors only during the later part of the book-building period. However, as the mechanics of the Hong Kong offer have already set a "cap" on the share price, the flexibility to price above the original price range is limited. Underwriters believe that this limitation prevents them from achieving the optimal balance between supply and demand with respect to the securities concerned.
- (ii) Underwriters further represent that the alternative to adjusting the price above the indicative price range is for them to set a higher upper end limit to the price range when the Hong Kong prospectuses are printed. The price range quoted in recent prospectuses shows a spread of between 15% and 25%. If this spread were to be increased in all global offers in order to provide greater flexibility for pricing, investors under the subscription tranche would be unduly affected, as the difference between the issue price of the shares and the application price (at the upper end of the range) would increase, causing corresponding increase in the cost to investors under the subscription tranche.
- (iii) Underwriters have also stated that if they were to adjust the price range upwards, they would need to ensure that the new price range overlaps to a certain degree with the original range. As indications of interest received during book-building only relate to the initial quoted range, underwriters have to ensure that any new price range does not exclude indications of interest already received. Therefore, the lower end limit of any new price range should, in practice, be no higher than the upper end limit of the original range. Any upward adjustment, therefore, would not be materially out of context with the original quoted range.
...
- ***(i)*** ***Full disclosure in prospectuses of the possible changes that could be made*** - Prospectuses should include prominent disclosure of the risks that the price range, size and/or the timing of an issue may be changed, and that in the event of a change in any of these matters, any investor who has already made an application may withdraw the application and if he so wishes, submit a new application. Prospectuses should also include details as to how and when shareholders will be advised of any change and what steps, if any, need to be taken by investors in respect of their applications if a change does occur. In addition, the issuer should display a prominent warning next to all boxes for application forms stating that changes to the price range, size and/or timing of an issue may be made, and if such change does take place, the latest date on which an announcement would be published and in which newspapers, to inform the market of the change. On the day immediately after an announcement of change is made, the issuer should also display a prominent notice next to all boxes for application forms summarising the change and how it might affect applications.
- ***(ii) Disclosure of actual changes made by newspaper announcements no later than the day before the subscription is due to close*** - Any change in the price range, size or timing of an issue should be announced in newspapers as soon as practicable after a change is to be effected and in any event, no later than the day before the offer is due to close. The announcement should: specify the revised terms of an offer;
- explain what impact, if any, the revised terms would have on the applications made or to be made by investors;
- remind investors who have submitted applications of their right to withdraw applications and the timing during which to do so, and if they so wish, to submit new applications; and
- provide up-to-date information on the issuer including, as a minimum, impact on any forecast profit or forecast earnings per share of the issuer, and statements as to sufficiency of working capital, use of proceeds and net asset values of the issuer.
- ***(iii)*** ***Providing investors with a right to withdraw*** - Investors who have submitted application for shares prior to announcement of any change in the terms of an offer should be allowed to withdraw the original application, and if they so wish, to make a revised application having regard to the changes. It is anticipated that underwriters would choose to allow investors to withdraw by cancelling their cheques submitted with their original applications. The SFC and the SEHK note that at present, investors who have applied for shares prior to an announcement of a reduction of the price below the original price range are only entitled to receive refund of the requisite application moneys plus costs. It is recommended that the right to withdraw should be extended to such investors.
...
- (i) they are existing customers of underwriters investing through corporations, partnerships, family trusts, etc ;
- (ii) they are active investors who generally invest in secondary markets in large size; and
- (iii) they are investors who have previously purchased shares in more than three initial public offerings through the underwriters,
...
- (i) to the Listing Rules requirements that no multiple applications could be made; and
- (ii) to the interim measures with respect to the Allocation of Shares in Initial Public Offerings issued by the SEHK and the SFC in May 1997 ***(the*** " ***1997 Joint Announcement")(Appendix 6*** ).
...
- (i) As in the subscription tranche where no restrictions on access have been placed on any particular type of investors, similarly no restrictions on access to any particular type of investors should apply to the placing tranche. Therefore, retail or individual investors who meet the criteria laid down by underwriters for investors under the placing tranche should be given the chance to apply for shares so long as they are not treated differently or "preferentially" than other investors who apply for shares under that tranche. Underwriters should not be required to exclude individual retail investors from the placing tranche as they are currently required to do.
- (ii) Offers by way of subscription have historically been open to all investors. The subscription tranche in the combined offering mechanism has also operated along the same lines in the past four years. There is no particular reason to change this practice. However, the high level of applications made by non-retail Hong Kong investors (which resulted in high over-subscription rates) have caused adverse impact on the monetary system, and have reduced the opportunity of local retail investors in obtaining more shares under the subscription tranche. These issues should be addressed. Therefore, whilst non-retail investors should be allowed to continue to participate in the subscription tranche, the shares which they could apply for should be limited or scaled down. This would have the benefit of providing greater opportunity for retail investors to obtain more shares under the subscription tranche. The interim measures set out in the 1997 Joint Announcement (which prevent investors from applying for more than 50% of the shares available under the subscription tranche) could be adopted as long term measures.
- (iii) In order to ensure that this Option 2 would not operate to encourage investors to apply for shares under both tranches, rules against "double-dipping" or applying for shares under more than one tranche should be introduced. So far as the subscription tranche is concerned, there are, at present, rules against multiple applications. Such rules should have the effect of preventing investors from applying under both pool A and pool B of the subscription tranche at the same time. Additional requirements, however, would have to be introduced to ensure that an investor (whether he is a retail, a professional or an institutional investor) would not be able to acquire shares under the subscription tranche and the placing tranche for the same issue simultaneously. This could be done, for example, by requiring investors under the subscription tranche to undertake and confirm in the application form that he has not indicated and would not indicate interest for shares under the placing tranche; and by requiring investors under the placing tranche to provide an undertaking or confirmation to the underwriters before shares are being allocated to them that they have not applied, and would not apply, for shares under the subscription tranche of the same issue.
73. In summary, Option 2 has the following characteristics:

- (i) All investors would be eligible to apply for shares under both the placing and the subscription tranche. In this respect, Option 2 is less restrictive than Option 1 which operates to exclude the majority of individual retail investors from participating in the placing tranche in practice.
- (ii) Different criteria would be applicable to each tranche to maintain "fairness of treatment" to investors under the same tranche. It recognises that treatment to investors between tranches is inherently different.
- (iii) Option 2 is, however, restrictive in two principal respects. First, as in the case of Option 1, it seeks to restrict the shares in respect of which "non-retail" investors are allowed to apply for under the subscription tranche by adopting the interim measures introduced in the 1997 Joint Announcement as long term measures. Secondly, if and to the extent that an investor (whether retail, institutional or professional) has chosen to apply for shares under either the placing or the subscription tranche, Option 2 seeks to prevent him from applying for shares under the other tranche of the same issue. Accordingly, it is up to the investor to decide which tranche he wishes to participate in, but once he has applied for or indicated interest for shares under either tranche, he would be excluded from participating in the other tranche of the same issue. This latter requirement is currently not applicable to Option 1.
***(c) Option 3***
...
- (i) small investors would receive a larger percentage of their application than the percentage they currently receive;
- (ii) the total funds required in the subscription would be decreased thus reducing pressures on the monetary system; and
- (iii) there may be an increase in under-subscription for unpopular issues.
...
- (i) "Retail" investors would be defined to mean investors who apply for or indicate interest for shares in the value of HK$5 million or below. They would only be eligible to apply for shares under the subscription tranche. Any investor who wishes to apply for shares exceeding the value of HK$5 million would be regarded as "non-retail" investors. They would only be eligible to participate in the placing tranche.
- (ii) The HK$5 million criterion of distinguishing "retail" investors from "non-retail" investors disregards whether the investor concerned is an individual or an institution. If Option 3 is adopted, the interim measures set out in the 1997 Joint Announcement and the criteria set out in paragraph 65 above (in allowing certain individual retail investors to participate in the placing tranche) would not be applicable. However, the present rules against multiple applications in the subscription tranche would continue to apply.
- (iii) One of the suggestions put forward as a variation of Option 3 is for the shares of the placing tranche to be divided so that part of the shares available would be designated for placing to international non-retail investors to be conducted by an international syndicate of underwriters, and the remaining part of the shares would be designated for placing to Hong Kong non-retail investors to be conducted by a local syndicate of underwriters so that a Hong Kong book-building tranche within the placing tranche is to be set up.
...
- ***(i)*** ***It is asserted that the gross number of indications of interest expressed by investors during book-building is not meaningful information, and in many instances, may be misleading information -*** This is because firstly, unlike application forms submitted by applicants under the public subscription tranche, indications of interest by investors during book-building are not binding in nature, whether on the issuer's part or on the investors' part. Secondly, many investors tend to inflate their demand for shares so that their indications of interest do not reflect the actual amount of shares they wish to acquire ultimately. Thirdly, underwriters argue that the gross number of indications takes no account of the "quality" of the demand, the allocation of which is subject to their discretion based on, for example, whether the investors are likely to be long-term or shorter-term holders of the shares. Therefore, underwriters believe that disclosure of indications of interest would not actually provide the desired transparency but may be misleading to the market.
- ***(ii)*** ***It is asserted that disclosure of the gross number of indications of interest would promote speculative behaviour and create volatility in the secondary market -*** Underwriters argue that this is particularly the case where the gross number of indications of interest is high : the high gross number tends to suggest that the issue is "hot", so disclosure of such information would likely influence more investors to speculate on the securities in the secondary market, creating volatility.
- ***(iii)*** ***It is asserted that requiring this disclosure of interest would be contrary to current international practice*** - Underwriters point out that if the requirement of disclosing the gross number of indications of interest under the book is imposed in Hong Kong, it would be contrary to the current practice of book-built placings. This may impair the workings of simultaneous global offerings involving Hong Kong and other major markets. No other international markets require such information to be disclosed.
- ***(iv) It is asserted that requiring this disclosure of interest would be inconsistent with the concerns*** ***of overseas regulators*** - U.S. underwriters have claimed that the U.S. Securities and Exchange Commission (the " ***SEC*** ") had cautioned broker-dealers not to disseminate information on indications of interest on book-building to the public. U.S. underwriters claim, therefore, to be concerned that publication of the level of interest would, if it came to the attention of the SEC, result in questions or objections on the part of the SEC. However, no specific U.S. rule prohibiting such disclosure has been brought to our attention. Furthermore, based on SFC's discussions with relevant SEC staff, the SFC has been given to understand that there is no such rule.
