...
The disciplinary action follows an SFC investigation into BNPP Securities Asia&rsquo;s dark liquidity pool trading services, known as the BNP Internal Exchange (BIX). The SFC found that:
...
Mr Mark Steward, the SFC&rsquo;s Executive Director of Enforcement, said &ldquo;No one should dive into dark water without knowing what is hidden. Operators must have clear rules and procedures in place for operating dark pools, and equally important, they should operate consistently with representations to clients whose consent to enter the dark pool is clear and well-informed.&rdquo;
...
- BNPP Securities Asia co-operated with the SFC in resolving the SFC&rsquo;s concerns;
...
- Among the licensing conditions imposed on BNPP Securities Asia&rsquo;s Type 7 regulated activities, BNPP Securities Asia was required to notify the SFC of any incident of material service breakdown or disruption of the operations of BIX affecting its users.
...
- The enhanced regulatory regime on alternative liquidity pools will come into force on 1 December 2015.