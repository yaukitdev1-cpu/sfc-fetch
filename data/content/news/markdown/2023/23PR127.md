The Securities and Futures Commission (SFC) today launched a further [consultation](https://apps.sfc.hk/edistributionWeb/gateway/EN/consultation/doc?refNo=23CP8) on implementing an uncertificated securities market (USM) in Hong Kong.
...
The latest consultation follows the SFC&rsquo;s earlier consultation in March 2023 on proposed subsidiary legislation for implementing a USM (Note 2).


Interested parties are invited to submit their comments to the SFC on or before 15 December 2023 via the SFC website ([www.sfc.hk](http://www.sfc.hk/)), by email ([usmconsult@sfc.hk](mailto:usmconsult@sfc.hk)), by post or by fax (2521 7917).
